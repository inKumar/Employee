...
<div class="container">
	...
	<p class="lead">
		<code>Add a Employee</code>
		:
		<code> Add a New Employee in your department</code>
	</p>
	<p></p>
	<p></p>
			...
			<form action="addNewEmp" method="post">
				<div class="form-group">
					<label for="fn"> First Name</label> <input class="form-control"
						type="text" name="firstName" text" value="">
				</div>

				<div class="form-group">
					<label for="ln"> Last Name</label> <input class="form-control"
						type="text" name="lastName" text" value="">
				</div>
                ...
                <label for="addressDto.street">Street</label> <input
                    class="form-control" name="addressDto.street"  type="text" value="">
                </div>
                <div class="form-group">
                <label for="addressDto.city">City</label> 
                <input class="form-control" name="addressDto.city"  type="text" value="">
                </div>
                <div class="form-group">
                  <label for="addressDto.state">State</label> <input
                      class="form-control" name="addressDto.state"  type="text" value="">
                  </div>
                  <div class="form-group">
                  <label for="addressDto.pincode">Pincode</label> 
                  <input class="form-control" name="addressDto.pincode"  type="text" value="">
                  </div>
